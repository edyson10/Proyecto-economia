...
import com.example.proyectoeconomia.Solucion.Solucion10Activity;
...
public class Ejercicio10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        solucion = (Button) findViewById(R.id.btnSolucion10);
    ...
    private void vistaSolucion(){
        Intent intent = new Intent(getApplicationContext(), Solucion10Activity.class);
