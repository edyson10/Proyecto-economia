...
import com.example.proyectoeconomia.Solucion.Solucion9Activity;
...
public class Ejercicio9Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        solucion = (Button) findViewById(R.id.btnSolucion9);
    ...
    private void vistaSolucion(){
        Intent intent = new Intent(getApplicationContext(), Solucion9Activity.class);
